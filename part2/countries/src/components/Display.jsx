const Display = ({country, weather, filteredCountries, selectCountry}) =>
{
    ...
    {
        console.log('Country data: ', country, ' and this is the weather ', weather)
        return(
        <>
